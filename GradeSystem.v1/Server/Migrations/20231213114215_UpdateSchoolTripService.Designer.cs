...
namespace GradeSystem.v1.Server.Migrations
{
    ...
    [Migration("20231213114215_UpdateSchoolTripService")]
    partial class UpdateSchoolTripService
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SchoolTripClasses", b =>
                {
                    ...
                    b.HasOne("SchoolTrip", null)
                        .WithOne("SchoolTripClasses")
                        .HasForeignKey("SchoolTripClasses", "SchoolTripID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("SchoolTripTeachers", b =>
                {
                    b.HasOne("SchoolTrip", null)
                        .WithOne("SchoolTripTeachers")
                        .HasForeignKey("SchoolTripTeachers", "SchoolTripID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
